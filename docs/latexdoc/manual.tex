...
\vskip2mm
The GUI execution is activated by clicking the \verb+cms Model+ item and after few seconds the model window will show up. Click the \includegraphics[scale=0.4]{fig_home} button, and you should see a well framed world map.
...
It make sense to run the model in batch mode if it collects the data of the run. Follow the instruction given in the ``Data Collection for Repast Java and ReLogo'' document provided in the documentation section of the RS web site to create text sinks.   
The files defined in this way will be found in the output folder at the end of the run.
