...
\includegraphics[scale=0.4]{fig_case1_map}
...
\includegraphics[scale=0.2]{fig_case1_qs}
\includegraphics[scale=0.2]{fig_case1_imports}

\noindent Data from market sessions

\includegraphics[scale=0.2]{fig_case1_prices}
\includegraphics[scale=0.2]{fig_case1_quantities}
...
\includegraphics[scale=0.2]{fig_case2_qs}
\includegraphics[scale=0.2]{fig_case2_imports}

\noindent Data from market sessions

\includegraphics[scale=0.2]{fig_case2_prices}
\includegraphics[scale=0.2]{fig_case2_quantities}
