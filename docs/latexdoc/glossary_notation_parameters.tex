\newglossaryentry{par:m}{
  ...
  name={$m$},% 
  description={percentage of demand bought in most expensive market to be moved in cheapest market}
}
\newglossaryentry{par:c}{
  type=parameter,% glossary type 
  name={$c$},% 
  description={parameter to obtain the threshold consumption below which demand curve is moved}
}
...
\newglossaryentry{par:iota}{
  type=parameter,% glossary type 
  name={$\iota$},% 
  description={tolerance in moving the demand from the most expensive to the cheapest market}
}
